...
import { BusinessDetailEntity } from '../common/entities.js';
...
export function BusinessDetailPage() {
  ...
  function handleStateChanges(
    ...
    if (isData) {
      const { imageUrl, name, address, phone, reviewsCount, isOpen, hours, reviews } =
        value;
